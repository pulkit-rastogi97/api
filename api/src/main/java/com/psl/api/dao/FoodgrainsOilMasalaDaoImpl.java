...
@Repository("foodgrainsOilMasalaDao")
public class FoodgrainsOilMasalaDaoImpl extends JdbcDaoSupport implements FoodgrainsOilMasalaDao {
    ...
    String sql;
    String tableName = "foodgrains_oil_masala";
