...
@Repository("kitchenGardenPetsDao")
public class KitchenGardenPetsDaoImpl extends JdbcDaoSupport implements KitchenGardenPetsDao {
    ...
    String sql;
    String tableName = "kitchen_garden_pets";
