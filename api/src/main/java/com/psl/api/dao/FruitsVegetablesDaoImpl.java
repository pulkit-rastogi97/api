...
@Repository("fruitsVegetablesDao")
public class FruitsVegetablesDaoImpl extends JdbcDaoSupport implements FruitsVegetablesDao {
    ...
    String sql;
    String tableName = "fruits_vegetables";
