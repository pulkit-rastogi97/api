...
import com.psl.api.bean.BakeryCakesDairy;
...
@Repository("bakeryCakesDao")
public class BakeryCakesDairyDaoImpl extends JdbcDaoSupport implements BakeryCakesDairyDao {
        ...
        String sql;
        String tableName = "bakery_cakes_dairy";
