...
@Repository("gourmetWorldFoodDao")
public class GourmetWorldFoodDaoImpl extends JdbcDaoSupport implements GourmetWorldFoodDao {
    ...
    String sql;
    String tableName = "gourmet_world_food";
